...
function ServicesCreate() {
  ...
  return (
    <>
      <title>Create Service | Signal CRM</title>
      <meta
        name="description"
        content="Create and configure new services in Signal CRM such as Hajj, Umrah, Packages, Medical, and Ticket. Set status and manage service setup"
      />
