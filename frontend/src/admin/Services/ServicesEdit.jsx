...
function ServicesEdit() {
  ...
  return (
    <>
      <title>Edit Service | Signal CRM</title>
      <meta
        name="description"
        content="Edit existing services in Signal CRM including Hajj, Umrah, Packages, Medical, and Ticket. Update details, status, and service configuration settings"
      />
