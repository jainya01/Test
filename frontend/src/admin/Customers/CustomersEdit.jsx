...
function CustomersEdit() {
  ...
  return (
    <>
      <title>Edit Customer | Signal CRM</title>
      <meta
        name="description"
        content="Update customer details, modify lead information, change service preferences, manage lead status, and keep customer records accurate."
      />
