...
function ServicesEdit() {
  ...
  return (
    <>
      <title>Edit Status | Signal CRM</title>
      <meta
        name="description"
        content="Edit existing lead status in Signal CRM, update status name, code, and workflow settings to improve lead tracking and pipeline management"
      />
