...
function Services() {
  ...
  return (
    <>
      <title>Status Management | Signal CRM</title>
      <meta
        name="description"
        content="Manage lead statuses in Signal CRM including New, Interested, Not Interested, Converted, and Follow-up. Update status codes and control workflow stages"
      />
