...
function ServicesCreate() {
  ...
  return (
    <>
      <title>Create Status | Signal CRM</title>
      <meta
        name="description"
        content="Create new lead status in Signal CRM, define status name and code, and configure workflow stages for better lead tracking and management"
      />
