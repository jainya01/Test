...
const Login = () => {
  ...
  return (
    <>
      <title>Login | Signal CRM - Call Tracking Platform</title>
      <meta
        name="description"
        content="Sign in to Signal CRM to manage calls, track leads, monitor conversions, access real-time analytics, oversee agents, and streamline telecalling operations."
      />
