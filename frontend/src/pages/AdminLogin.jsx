...
const AdminLogin = () => {
  ...
  return (
    <>
      <title>Admin Login | Signal CRM</title>
      <meta
        name="description"
        content="Securely sign in to Signal CRM as an administrator to manage agents, monitor call performance, track conversions, and access real-time analytics."
      />
          ...
          <div className="col-lg-6 col-sm-12 d-flex align-items-center justify-content-center bg-light mt-lg-4 mt-0">
            <div className="w-100 px-0" style={{ maxWidth: "450px" }}>
              ...
              <form onSubmit={handleAdminLogin}>
                ...
                <button
                  type="submit"
                  className="btn sign-in-btn w-100 py-2 mb-2"
                >
                  Log In
                </button>
